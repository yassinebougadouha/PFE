<?php $__env->startSection('title', 'Voice Agents Runtime - L2T Support'); ?>
...
(function(){
  ...
  async function api(path, options) {
    ...
    const base = <?php echo json_encode($apiBase, 15, 512) ?>;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/support/voice-agents.blade.php ENDPATH**/ ?>