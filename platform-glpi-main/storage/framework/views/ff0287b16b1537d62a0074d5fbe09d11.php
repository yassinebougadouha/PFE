        ...
        <div class="card z-index-0 fadeIn3 fadeInBottom">
          ...
          <div class="card-body">
            ...
            <?php if(session('status')): ?>
              <div class="alert alert-success text-sm mt-2"><?php echo e(session('status')); ?></div>
            <?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
              <div class="alert alert-danger text-sm mt-2"><?php echo e($message); ?></div>
            <?php unset($message);
            ...
            <line x1="1" y1="1" x2="23" y2="23"/>
              ...
              <?php if(Route::has('password.request')): ?>
                <div class="text-end mb-2">
                  <a class="text-sm text-body" href="<?php echo e(route('password.request')); ?>">
