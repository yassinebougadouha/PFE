...
<div class="d-flex align-items-center gap-2 mb-4">
  <a href="<?php echo e(route('admin.clients')); ?>" class="btn btn-sm btn-outline-secondary mb-0">
...
<div class="row g-4">
  ...
  <div class="col-lg-4">
    ...
    <div class="card mb-4" style="border-radius:16px;overflow:hidden;">
      ...
      <div class="card-body text-center" style="margin-top:-45px;">
        <?php if($client->avatar): ?>
          <img src="<?php echo e(asset('storage/'.$client->avatar)); ?>"
        ...
        <div class="mb-3">
          <span class="badge <?php echo e($client->is_active ? 'bg-gradient-success' : 'bg-gradient-secondary'); ?>">
        ...
        <div class="d-flex flex-column gap-3">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm font-weight-bold mb-0"><?php echo e($client->email); ?></p>
            </div>
          </div>
          <?php if($client->phone): ?>
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm font-weight-bold mb-0"><?php echo e($client->phone); ?></p>
            </div>
          </div>
          <?php endif; ?>
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm font-weight-bold mb-0">
                ...
                <?php if($client->phone_verified ?? false): ?>
                  <span class="badge bg-gradient-success ms-1" style="font-size:10px;">✓ Vérifié</span>
                <?php endif; ?>
              </p>
            </div>
          </div>
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm font-weight-bold mb-0"><?php echo e($client->whatsapp); ?></p>
            </div>
          </div>
          <?php endif; ?>
        </div>
    ...
    <div class="card mb-4" style="border-radius:16px;">
      <div class="card-header pb-0 pt-3 px-4">
        <h6 class="font-weight-bold mb-0">
          <i class="material-symbols-rounded me-2" style="font-size:18px;vertical-align:middle;color:var(--color-primary);">sell</i>
          Classifier ce client
        </h6>
      </div>
      <div class="card-body px-4 pb-4">
        ...
        <div class="row g-2">
          <div class="col-6">
            <div class="text-center p-3" style="background:#f8f9fa;border-radius:12px;">
              <p class="font-weight-bold mb-0" style="font-size:22px;color:var(--color-primary);"><?php echo e($total); ?></p>
              <p class="text-xs text-secondary mb-0">Total tickets</p>
            </div>
          </div>
          <div class="col-6">
            <div class="text-center p-3" style="background:#fef3c7;border-radius:12px;">
              <p class="font-weight-bold mb-0" style="font-size:22px;color:#d97706;"><?php echo e($pending); ?></p>
              <p class="text-xs text-secondary mb-0">En attente</p>
            </div>
          </div>
          <div class="col-6">
            <div class="text-center p-3" style="background:#dbeafe;border-radius:12px;">
              <p class="font-weight-bold mb-0" style="font-size:22px;color:#2563eb;"><?php echo e($inprog); ?></p>
              <p class="text-xs text-secondary mb-0">En cours</p>
            </div>
          </div>
          <div class="col-6">
            <div class="text-center p-3" style="background:#dcfce7;border-radius:12px;">
              <p class="font-weight-bold mb-0" style="font-size:22px;color:#16a34a;"><?php echo e($resolved); ?></p>
  ...
  <div class="col-lg-8">
    <div class="card" style="border-radius:16px;">
        ...
        <div class="d-flex align-items-center justify-content-between">
          <h6 class="font-weight-bold mb-0">
            ...
            <span class="badge ms-2" style="background:linear-gradient(135deg,var(--color-primary),var(--color-secondary));color:#fff;font-size:11px;">
              <?php echo e($client->tickets_count); ?>
      ...
      <div class="card-body px-0 pb-0">
        ...
        <div class="px-4 py-3"><?php echo e($tickets->links()); ?></div>
        <?php endif; ?>
      </div>
    </div>
  </div>
...
function saveClientType(t) {
  ...
  .then(function(data) {
    if (data.success || data.ok) {
      _origType = type;
      if (fb) { fb.textContent = '✅ Client enregistré'; fb.className = 'alert alert-success py-2 px-3 mb-0 text-sm'; }
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/client-detail.blade.php ENDPATH**/ ?>