<?php $__env->startSection('title', 'Conversations – Supervision'); ?>
  ...
  <aside class="sv-admins">
    ...
    <div class="sv-user-tabs">
      <button class="sv-user-tab active" data-type="admin" onclick="switchUserType(this,'admin')">
        ...
        Admins
        <span class="sv-ut-cnt" id="adminCnt"><?php echo e($allAdmins->count()); ?></span>
      </button>
      <button class="sv-user-tab" data-type="client" onclick="switchUserType(this,'client')">
        ...
        Clients
        <span class="sv-ut-cnt" id="clientCnt"><?php echo e($allClients->count()); ?></span>
      </button>
    </div>
    ...
    <div class="sv-admins-list" id="adminList">
      ...
      <div class="sv-admin-item" data-id="<?php echo e($admin->id); ?>" data-type="admin"
        ...
        <div class="sv-admin-avatar" style="background:linear-gradient(135deg,var(--color-primary),var(--color-secondary,#7c3aed));">
          <?php if($admin->avatar): ?><img src="<?php echo e(asset('storage/'.$admin->avatar)); ?>" alt="">
          <?php else: ?><?php echo e(strtoupper(substr($admin->name,0,2))); ?><?php endif; ?>
          <span class="sv-admin-dot"></span>
        </div>
        <div class="sv-admin-info">
          <div class="sv-admin-name"><?php echo e($admin->name); ?></div>
      ...
      <div class="sv-admin-item" data-id="<?php echo e($client->id); ?>" data-type="client"
        ...
        <div class="sv-admin-avatar" style="background:linear-gradient(135deg,#0ea5e9,#0284c7);">
          <?php if($client->avatar): ?><img src="<?php echo e(asset('storage/'.$client->avatar)); ?>" alt="">
          <?php else: ?><?php echo e(strtoupper(substr($client->name,0,2))); ?><?php endif; ?>
          <span class="sv-admin-dot" style="background:#0ea5e9;"></span>
        </div>
        <div class="sv-admin-info">
          <div class="sv-admin-name"><?php echo e($client->name); ?></div>
