...
<div class="alert alert-danger alert-dismissible fade show mb-3">
  <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <p class="mb-0 text-sm">⚠ <?php echo e($error); ?></p>
...
<div class="row mb-2">
  <div class="col-12">
    ...
    <ul class="nav nav-fill mb-3 flex-wrap" id="settingsTabs" role="tablist"
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo e($activeTab === 'general' ? 'active' : ''); ?>" data-bs-toggle="pill" href="#general">
          <i class="material-symbols-rounded">info</i>Général
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo e($activeTab === 'tickets' ? 'active' : ''); ?>" data-bs-toggle="pill" href="#tickets">
          <i class="material-symbols-rounded">confirmation_number</i>Tickets
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo e($activeTab === 'security' ? 'active' : ''); ?>" data-bs-toggle="pill" href="#security">
          <i class="material-symbols-rounded">security</i>Sécurité
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo e($activeTab === 'notifications' ? 'active' : ''); ?>" data-bs-toggle="pill" href="#notifications">
          <i class="material-symbols-rounded">notifications</i>Notifications
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo e($activeTab === 'system' ? 'active' : ''); ?>" data-bs-toggle="pill" href="#system">
          <i class="material-symbols-rounded">computer</i>Système
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo e($activeTab === 'glpi' ? 'active' : ''); ?>" data-bs-toggle="pill" href="#glpi">
          <i class="material-symbols-rounded">api</i>GLPI
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo e($activeTab === 'sms' ? 'active' : ''); ?>" data-bs-toggle="pill" href="#sms">
          <i class="material-symbols-rounded">sms</i>SMS
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo e($activeTab === 'voice_agents' ? 'active' : ''); ?>" data-bs-toggle="pill" href="#voice_agents">
...
<div class="tab-content">
  ...
  <div class="tab-pane fade <?php echo e($activeTab === 'general' ? 'show active' : ''); ?>" id="general">
    <div class="row">
      <div class="col-lg-8">
        <div class="card mb-4">
          ...
          <div class="card-body px-4">
            <form action="<?php echo e(route('super-admin.settings')); ?>" method="POST">
              <?php echo csrf_field(); ?>
              ...
              <div class="mb-3">
                ...
                <input type="text" name="app_name" class="form-control border px-3"
                       value="<?php echo e(old('app_name', $settings['app_name'] ?? 'L2T')); ?>" required>
              </div>
              <div class="mb-3">
                ...
                <input type="email" name="support_email" class="form-control border px-3"
                       value="<?php echo e(old('support_email', $settings['support_email'] ?? 'support@l2t.com')); ?>" required>
              </div>
              <div class="mb-3">
                <label class="form-label text-sm font-weight-bold">Description</label>
                <textarea name="description" class="form-control border px-3" rows="3"><?php echo e(old('description', $settings['description'] ?? '')); ?></textarea>
              </div>
      ...
      <div class="col-lg-4">
        <div class="card">
          ...
          <div class="card-body px-4 text-center">
            <div class="mb-3">
              <img src="<?php echo e($settings['logo_path'] ?? asset('assets/img/logo-l2t.png')); ?>?v=<?php echo e(time()); ?>"
            ...
            <form action="<?php echo e(route('super-admin.settings')); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              <?php echo method_field('PUT'); ?>
  ...
  <div class="tab-pane fade <?php echo e($activeTab === 'tickets' ? 'show active' : ''); ?>" id="tickets">
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header pb-0 pt-3 px-4">
            ...
            <form action="<?php echo e(route('super-admin.settings')); ?>" method="POST">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" id="autoAssign" name="auto_assignment"
                           <?php echo e(($settings['auto_assignment'] ?? '0') === '1' ? 'checked' : ''); ?>>
                  ...
                  <select name="auto_assignment_method" class="form-select form-select-sm mb-3">
                    <?php $__currentLoopData = ['Round-robin','Par catégorie','Par charge']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e(($settings['auto_assignment_method'] ?? 'Round-robin') === $m ? 'selected' : ''); ?>><?php echo e($m); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                  <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" id="clientClose" name="allow_client_close"
                           <?php echo e(($settings['allow_client_close'] ?? '0') === '1' ? 'checked' : ''); ?>>
                ...
                <div class="col-md-6">
                  ...
                  <?php $__currentLoopData = ['Très haute'=>'4h','Haute'=>'8h','Moyenne'=>'24h','Basse'=>'48h']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="d-flex align-items-center mb-2 gap-2">
                    <span class="text-xs" style="min-width:80px;"><?php echo e($p); ?></span>
                    <input type="text" name="sla_<?php echo e(strtolower($p)); ?>" class="form-control form-control-sm"
                           value="<?php echo e($settings['sla_'.strtolower($p)] ?? $d); ?>" style="max-width:80px;">
  ...
  <div class="tab-pane fade <?php echo e($activeTab === 'security' ? 'show active' : ''); ?>" id="security">
    <div class="card">
      <div class="card-header pb-0 pt-3 px-4">
        ...
        <form action="<?php echo e(route('super-admin.settings')); ?>" method="POST">
          ...
          <div class="row mb-3">
            <div class="col-md-4">
              ...
              <input type="number" name="min_password_length" class="form-control"
                     value="<?php echo e($settings['min_password_length'] ?? 8); ?>" min="6" max="32">
            </div>
            <div class="col-md-4">
              <label class="form-label text-xs">Session timeout (minutes)</label>
              <input type="number" name="session_timeout" class="form-control"
                     value="<?php echo e($settings['session_timeout'] ?? 120); ?>">
            </div>
            <div class="col-md-4">
          ...
          <div class="form-check form-switch mb-2">
            <input class="form-check-input" type="checkbox" id="passComplex" name="password_complexity"
                   <?php echo e(($settings['password_complexity'] ?? '0') === '1' ? 'checked' : ''); ?>>
          ...
          <div class="form-check form-switch mb-2">
            <input class="form-check-input" type="checkbox" id="allowReg" name="allow_registration"
                   <?php echo e(($settings['allow_registration'] ?? '1') === '1' ? 'checked' : ''); ?>>
          ...
          <div class="form-check form-switch mb-2">
            <input class="form-check-input" type="checkbox" id="emailVerif" name="require_email_verification"
                   <?php echo e(($settings['require_email_verification'] ?? '0') === '1' ? 'checked' : ''); ?>>
          ...
          <div class="form-check form-switch mb-3">
            <input class="form-check-input" type="checkbox" id="twoFactor" name="two_factor_auth"
                   <?php echo e(($settings['two_factor_auth'] ?? '0') === '1' ? 'checked' : ''); ?>>
  ...
  <div class="tab-pane fade <?php echo e($activeTab === 'notifications' ? 'show active' : ''); ?>" id="notifications">
    ...
    <div class="card">
      ...
      <div class="card-body px-4">
        <form action="<?php echo e(route('super-admin.settings')); ?>" method="POST">
            ...
            <div class="d-flex gap-3">
              <div class="form-check">
                <input class="form-check-input" type="radio" name="mail_mode" id="mode_gmail" value="gmail"
                       <?php echo e(($settings['mail_mode'] ?? 'gmail') === 'gmail' ? 'checked' : ''); ?>
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="mail_mode" id="mode_smtp" value="smtp"
                       <?php echo e(($settings['mail_mode'] ?? '') === 'smtp' ? 'checked' : ''); ?>
          ...
          <div id="gmail_section" style="display:<?php echo e(($settings['mail_mode'] ?? 'gmail') === 'gmail' ? 'block' : 'none'); ?>;">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="email" name="gmail_from_email" class="form-control"
                       value="<?php echo e($settings['gmail_from_email'] ?? ''); ?>" placeholder="votre@gmail.com"
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="smtp_from_name" class="form-control"
                       value="<?php echo e($settings['smtp_from_name'] ?? 'L2T Support'); ?>"
                       style="height:45px;border:1px solid #d2d6da;border-radius:8px;padding:0 12px;">
              </div>
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="gmail_client_id" class="form-control"
                       value="<?php echo e($settings['gmail_client_id'] ?? ''); ?>" placeholder="xxxx.apps.googleusercontent.com"
                       style="height:45px;border:1px solid #d2d6da;border-radius:8px;padding:0 12px;">
              </div>
              <div class="col-md-4 mb-3">
                ...
                <input type="password" name="gmail_client_secret" class="form-control"
                       placeholder="<?php echo e(!empty($settings['gmail_client_secret']) ? '••••••••' : 'Client Secret'); ?>"
                       style="height:45px;border:1px solid #d2d6da;border-radius:8px;padding:0 12px;">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="password" name="gmail_refresh_token" class="form-control"
                       placeholder="<?php echo e(!empty($settings['gmail_refresh_token']) ? '••••••••' : 'Refresh Token'); ?>"
                       style="height:45px;border:1px solid #d2d6da;border-radius:8px;padding:0 12px;">
                <p class="text-xs text-muted mt-1">Laisser vide = inchangé</p>
              </div>
            </div>
          ...
          <div id="smtp_section" style="display:<?php echo e(($settings['mail_mode'] ?? 'gmail') === 'smtp' ? 'block' : 'none'); ?>;">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="email" name="smtp_from_email_field" class="form-control"
                       value="<?php echo e($settings['smtp_from_email'] ?? ''); ?>" placeholder="votre@email.com"
                       style="height:45px;border:1px solid #d2d6da;border-radius:8px;padding:0 12px;">
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label text-xs font-weight-bold text-uppercase text-secondary">Nom expéditeur</label>
              ...
              <div class="col-md-2 mb-3">
                ...
                <select name="smtp_encryption" class="form-select" style="height:45px;border:1px solid #d2d6da;border-radius:8px;">
                  ...
                  <option value="" <?php echo e(($settings['smtp_encryption'] ?? '') === '' ? 'selected' : ''); ?>>Aucun</option>
                </select>
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-check mb-2">
                <input class="form-check-input" type="checkbox" name="<?php echo e($key); ?>" id="<?php echo e($key); ?>"
                       <?php echo e(($settings[$key] ?? '1') === '1' ? 'checked' : ''); ?>>
                <label class="form-check-label text-sm" for="<?php echo e($key); ?>"><?php echo e($label); ?></label>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div class="col-md-6">
        ...
        <form action="<?php echo e(route('super-admin.settings')); ?>" method="POST">
            ...
            <div class="row g-2 mt-1">
              <div class="col-md-6">
                <label class="d-block p-3 border border-radius-lg" style="cursor:pointer;transition:all .15s;" id="lbl_general" onclick="selectTeamsMethod('general')">
                  <div class="d-flex align-items-center gap-2 mb-1">
                    <input class="form-check-input mt-0" type="radio" name="teams_routing_method" value="general" id="method_general" <?php echo e(($settings['teams_routing_method'] ?? 'general') === 'general' ? 'checked' : ''); ?>>
              ...
              <div class="col-md-6">
                <label class="d-block p-3 border border-radius-lg" style="cursor:pointer;transition:all .15s;" id="lbl_category" onclick="selectTeamsMethod('category')">
                  <div class="d-flex align-items-center gap-2 mb-1">
                    <input class="form-check-input mt-0" type="radio" name="teams_routing_method" value="category" id="method_category" <?php echo e(($settings['teams_routing_method'] ?? '') === 'category' ? 'checked' : ''); ?>>
          ...
          <div class="p-3 border-radius-lg mb-3" style="background:#f0f0ff;border:1px solid #6264A7;">
            ...
            <input type="text" name="teams_webhook_url" class="form-control"
                   value="<?php echo e($settings['teams_webhook_url'] ?? config('services.teams.webhook_url', '')); ?>"
          ...
          <div id="section_category" style="<?php echo e(($settings['teams_routing_method'] ?? 'general') === 'category' ? '' : 'display:none;'); ?>">
            <div class="p-3 border-radius-lg mb-3" style="background:#f0fff4;border:1px solid #22c55e;">
              ...
              <div class="table-responsive">
                <table class="table table-sm align-middle mb-0">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $teamsCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catKey => $catLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $tmap = $teamsMappings[$catKey] ?? null; ?>
                    <tr>
                      <td><span class="badge bg-gradient-secondary text-white px-2 py-1"><?php echo e($catLabel); ?></span></td>
                      <td>
                        <select name="category_admin[<?php echo e($catKey); ?>]" class="form-select form-select-sm" style="min-width:180px;">
                          <option value="">— Non assigné —</option>
                          <?php $__currentLoopData = $teamsAdmins2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($adm->id); ?>" <?php echo e(($tmap && isset($tmap->admin_id) && $tmap->admin_id == $adm->id) ? 'selected' : ''); ?>>
                            <?php echo e($adm->name); ?> <?php echo e($adm->teams_email ? '('.$adm->teams_email.')' : ''); ?>
  ...
  <div class="tab-pane fade <?php echo e($activeTab === 'system' ? 'show active' : ''); ?>" id="system">
    <div class="row">
          ...
          <div class="card-body px-4">
            <table class="table table-sm">
              <tr>
                ...
                <td><span class="badge bg-gradient-info"><?php echo e(app()->version()); ?></span></td>
              </tr>
              <tr>
                <td class="text-sm font-weight-bold">PHP Version</td>
                <td><span class="badge bg-gradient-info"><?php echo e(phpversion()); ?></span></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <span class="badge bg-gradient-<?php echo e(config('app.env') === 'production' ? 'success' : 'warning'); ?>">
              ...
              <tr>
                ...
                <td>
                  <span class="badge bg-gradient-<?php echo e(config('app.debug') ? 'danger' : 'success'); ?>">
      ...
      <div class="col-lg-6 mb-4">
        <div class="card">
          ...
          <div class="card-body px-4">
            <form action="<?php echo e(route('super-admin.settings')); ?>" method="POST" class="mb-2">
              <?php echo csrf_field(); ?>
              <?php echo method_field('PUT'); ?>
            ...
            <form action="<?php echo e(route('super-admin.settings')); ?>" method="POST">
              ...
              <button type="submit" class="btn btn-outline-danger w-100 mb-0"
                ...
                <?php echo e(app()->isDownForMaintenance() ? 'Désactiver maintenance' : 'Activer maintenance'); ?>
  ...
  <div class="tab-pane fade <?php echo e($activeTab === 'glpi' ? 'show active' : ''); ?>" id="glpi">
    ...
    <div class="row">
            ...
            <div class="row mb-3">
              <div class="col-md-4">
                <div class="p-3 border-radius-md text-center" style="background:#f0f4ff;">
                  <h5 class="font-weight-bolder mb-0" style="color:var(--color-primary);"><?php echo e(\App\Models\User::whereIn('role',['admin','client'])->count()); ?></h5>
                  <p class="text-xs text-secondary mb-0">Users total</p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="p-3 border-radius-md text-center" style="background:#e8f5e9;">
                  <h5 class="font-weight-bolder mb-0" style="color:#2e7d32;"><?php echo e(\App\Models\User::whereNotNull('glpi_user_id')->count()); ?></h5>
              ...
              <div class="col-md-4">
                <div class="p-3 border-radius-md text-center" style="background:#fff3e0;">
                  <h5 class="font-weight-bolder mb-0" style="color:#e65100;"><?php echo e(\App\Models\User::whereIn('role',['admin','client'])->whereNull('glpi_user_id')->count()); ?></h5>
            ...
            <form action="<?php echo e(route('super-admin.settings')); ?>" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="url" name="glpi_url" class="form-control"
                       value="<?php echo e($settings['glpi_url'] ?? config('services.glpi.url')); ?>"
              ...
              <div class="mb-3">
                ...
                <input type="text" name="glpi_app_token" class="form-control"
                       value="<?php echo e($settings['glpi_app_token'] ?? config('services.glpi.app_token')); ?>"
              ...
              <div class="mb-3">
                ...
                <input type="password" name="glpi_user_token" class="form-control"
                       placeholder="<?php echo e(!empty($settings['glpi_user_token']) ? '••••••••' : 'User Token GLPI'); ?>"
                       style="height:45px;border:1px solid #d2d6da;border-radius:8px;padding:0 12px;">
              </div>
        ...
        <div class="card h-100">
          <div class="card-header pb-0 pt-3 px-4 d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-sm mb-0 text-white" style="background:var(--color-primary);"
                    onclick="glpiCall('profiles-result','/glpi/profiles')">
              <i class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">refresh</i>
              Charger
            </button>
          </div>
          <div class="card-body px-4 pb-4">
            <button class="btn btn-sm mb-0 btn-outline-secondary mb-3"
                    onclick="glpiCall('profiles-result','/glpi/profiles/active')">Profil actif</button>
            <div id="profiles-result"><p class="text-xs text-secondary">Cliquez sur Charger</p></div>
            <hr class="my-3">
            <p class="text-xs font-weight-bold text-uppercase text-secondary mb-2">Changer de profil</p>
            <div class="d-flex gap-2">
              <input type="number" id="profileId" class="form-control form-control-sm" placeholder="ID profil" style="width:120px;">
              <button class="btn btn-sm mb-0 text-white" style="background:var(--color-primary);" onclick="changeGlpiProfile()">Changer</button>
            </div>
      ...
      <div class="col-lg-6 mb-4">
        <div class="card h-100">
          <div class="card-header pb-0 pt-3 px-4 d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-sm mb-0 text-white" style="background:var(--color-primary);"
                    onclick="glpiCall('entities-result','/glpi/entities')">
              <i class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">refresh</i>
              Charger
            </button>
          </div>
          <div class="card-body px-4 pb-4">
            <button class="btn btn-sm mb-0 btn-outline-secondary mb-3"
                    onclick="glpiCall('entities-result','/glpi/entities/active')">Entité active</button>
            <div id="entities-result"><p class="text-xs text-secondary">Cliquez sur Charger</p></div>
            <hr class="my-3">
            <p class="text-xs font-weight-bold text-uppercase text-secondary mb-2">Changer d'entité</p>
            <div class="d-flex gap-2 align-items-center flex-wrap">
              <input type="text" id="entityId" class="form-control form-control-sm" placeholder="ID ou 'all'" style="width:100px;">
              <div class="form-check mb-0">
                <input class="form-check-input" type="checkbox" id="entityRecursive">
                <label class="form-check-label text-xs" for="entityRecursive">Récursif</label>
              </div>
              <button class="btn btn-sm mb-0 text-white" style="background:var(--color-primary);" onclick="changeGlpiEntity()">Changer</button>
            </div>
            <div id="entity-result" class="mt-2"></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 mb-4">
        <div class="card h-100">
          ...
          <div class="card-body px-4 pb-4">
            <div class="row mb-3">
              <div class="col-6">
                <label class="form-label text-xs text-secondary">Type d'item</label>
                <select id="srchType" class="form-control form-select form-control-sm">
              ...
              <div class="col-6">
                <label class="form-label text-xs text-secondary">Valeur</label>
                <input type="text" id="srchValue" class="form-control form-control-sm" placeholder="Terme...">
              </div>
            </div>
            <button class="btn btn-sm mb-0 text-white w-100" style="background:var(--color-primary);" onclick="runGlpiSearch()">
              <i class="material-symbols-rounded me-1" style="font-size:14px;vertical-align:middle;">search</i>Rechercher
            </button>
            <button class="btn btn-sm mb-0 btn-outline-secondary w-100 mt-2"
                    onclick="glpiCall('search-result', '/glpi/search/'+document.getElementById('srchType').value+'/options')">
              Voir champs disponibles
            </button>
            <div id="search-result" class="mt-3"><p class="text-xs text-secondary">Résultats ici</p></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 mb-4">
        <div class="card h-100">
          <div class="card-header pb-0 pt-3 px-4">
            <h6 class="mb-0 font-weight-bold">Documents & Photos</h6>
          </div>
          <div class="card-body px-4 pb-4">
            <p class="text-xs font-weight-bold text-uppercase text-secondary mb-2">Upload document</p>
            <div class="d-flex gap-2 mb-2">
              <input type="file" id="glpiUploadFile" class="form-control form-control-sm">
              <button class="btn btn-sm mb-0 text-white flex-shrink-0" style="background:var(--color-primary);" onclick="uploadGlpiDoc()">Upload</button>
            </div>
            <div id="upload-result" class="mb-3"></div>
            <hr class="my-3">
            <p class="text-xs font-weight-bold text-uppercase text-secondary mb-2">Télécharger document</p>
            <div class="d-flex gap-2 mb-3">
              <input type="number" id="dlDocId" class="form-control form-control-sm" placeholder="ID doc GLPI">
              <a id="dlDocLink" href="#" target="_blank" class="btn btn-sm mb-0 text-white flex-shrink-0" style="background:#28a745;" onclick="buildDlLink(event)">
                <i class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">download</i>
              </a>
            </div>
            <hr class="my-3">
            <p class="text-xs font-weight-bold text-uppercase text-secondary mb-2">Photo utilisateur GLPI</p>
            <div class="d-flex gap-2 align-items-center">
              <input type="number" id="picUserId" class="form-control form-control-sm" placeholder="ID user GLPI">
              <button class="btn btn-sm mb-0 text-white flex-shrink-0" style="background:var(--color-primary);" onclick="showUserPic()">Voir</button>
            </div>
            <div id="user-pic-result" class="mt-2"></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 mb-4">
        <div class="card h-100">
          <div class="card-header pb-0 pt-3 px-4">
            <h6 class="mb-0 font-weight-bold">Massive Actions GLPI</h6>
          </div>
          <div class="card-body px-4 pb-4">
            <div class="mb-3">
              <label class="form-label text-xs text-secondary">Type d'item</label>
              <select id="massiveType" class="form-control form-select form-control-sm">
                <option value="Ticket">Ticket</option>
                <option value="User">User</option>
                <option value="Computer">Computer</option>
              </select>
            </div>
            <button class="btn btn-sm mb-0 text-white w-100 mb-2" style="background:var(--color-primary);"
                    onclick="glpiCall('massive-result', '/glpi/massive-actions/'+document.getElementById('massiveType').value)">
              <i class="material-symbols-rounded me-1" style="font-size:14px;vertical-align:middle;">list</i>Voir actions disponibles
            </button>
            <div class="mb-3">
              <label class="form-label text-xs text-secondary mt-2">Clé action</label>
              <input type="text" id="massiveActionKey" class="form-control form-control-sm" placeholder="Ex: MassiveAction:update">
            </div>
            <button class="btn btn-sm mb-0 btn-outline-secondary w-100" onclick="loadMassiveParams()">Voir paramètres de cette action</button>
            <div id="massive-result" class="mt-3"><p class="text-xs text-secondary">Résultats ici</p></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 mb-4">
        <div class="card h-100">
          <div class="card-header pb-0 pt-3 px-4">
            <h6 class="mb-0 font-weight-bold">Reset Password GLPI</h6>
            <p class="text-xs text-secondary mb-0">Envoyer reset password directement via GLPI API</p>
          </div>
          <div class="card-body px-4 pb-4">
            <p class="text-xs font-weight-bold text-uppercase text-secondary mb-2">Demande de reset</p>
            <div class="d-flex gap-2 mb-3">
              <input type="email" id="resetEmail" class="form-control form-control-sm" placeholder="email@exemple.com">
              <button class="btn btn-sm mb-0 text-white flex-shrink-0" style="background:#f57c00;" onclick="glpiPasswordRequest()">
                <i class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">send</i>
              </button>
            </div>
            <div id="reset-request-result" class="mb-3"></div>
            <hr class="my-3">
            <p class="text-xs font-weight-bold text-uppercase text-secondary mb-2">Confirmer reset</p>
            <input type="email" id="resetEmail2" class="form-control form-control-sm mb-2" placeholder="Email">
            <input type="text" id="resetToken" class="form-control form-control-sm mb-2" placeholder="Token reçu par email">
            <input type="password" id="resetPwd" class="form-control form-control-sm mb-2" placeholder="Nouveau mot de passe">
            <button class="btn btn-sm mb-0 text-white w-100" style="background:#e53935;" onclick="glpiPasswordConfirm()">Confirmer reset</button>
            <div id="reset-confirm-result" class="mt-2"></div>
          </div>
        </div>
      </div>
  ...
  <div class="tab-pane fade <?php echo e($activeTab === 'sms' ? 'show active' : ''); ?>" id="sms" role="tabpanel">
    ...
    <form method="POST" action="<?php echo e(route('super-admin.settings')); ?>" id="smsForm">
      <?php echo csrf_field(); ?>
      <?php echo method_field('PUT'); ?>
        ...
        <div class="sms-split-left">
          ...
          <div class="sms-card-dark">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
              ...
              <?php $smsOk = \App\Models\Setting::get('sms_api_url') && \App\Models\Setting::get('sms_api_key'); ?>
              <span class="sms-status-pill <?php echo e($smsOk ? 'ok' : 'fail'); ?>">
                <span class="sms-status-dot <?php echo e($smsOk ? 'ok' : 'fail'); ?>"></span>
                <?php echo e($smsOk ? 'Configuré' : 'Non configuré'); ?>
          ...
          <div class="sms-card">
            ...
            <div class="sms-input-icon-wrap">
              ...
              <input type="url" name="sms_api_url" class="sms-input"
                     value="<?php echo e(\App\Models\Setting::get('sms_api_url', 'https://mystudents.tunisiesms.tn/api/sms')); ?>"
              ...
              <div class="col-md-6">
                ...
                <div class="sms-input-icon-wrap">
                  ...
                  <input type="password" name="sms_api_key" id="smsApiKey" class="sms-input"
                         value="<?php echo e(\App\Models\Setting::get('sms_api_key', '')); ?>" placeholder="votre-cle-api">
              ...
              <div class="col-md-6">
                ...
                <div class="sms-input-icon-wrap">
                  ...
                  <input type="text" name="sms_sender" class="sms-input" maxlength="11"
                         value="<?php echo e(\App\Models\Setting::get('sms_sender', 'L2T')); ?>"
          ...
          <div class="sms-card">
            ...
            ?>
            <?php $__currentLoopData = $triggers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$key, $label, $icon, $bg, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="sms-toggle-row">
              <div class="sms-toggle-label">
                <div class="sms-trigger-icon" style="background:<?php echo e($bg); ?>;">
                  <i class="material-symbols-rounded" style="font-size:16px;color:<?php echo e($color); ?>;"><?php echo e($icon); ?></i>
                </div>
                <span class="text-sm" style="color:#374151;font-weight:500;"><?php echo e($label); ?></span>
              </div>
              <div class="form-check form-switch mb-0" style="padding-left:2.5rem;">
                <input class="form-check-input" type="checkbox" name="<?php echo e($key); ?>" value="1"
                       ...
                       <?php echo e(\App\Models\Setting::get($key, '0') === '1' ? 'checked' : ''); ?>>
              </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
  ...
  <div class="tab-pane fade <?php echo e($activeTab === 'voice_agents' ? 'show active' : ''); ?>" id="voice_agents" role="tabpanel">
    <?php
...
(function(){
  ...
  async function api(path, options) {
    ...
    const base = <?php echo json_encode(rtrim((string) config('services.support_api.public_url'), '/'), 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/super-admin/settings.blade.php ENDPATH**/ ?>