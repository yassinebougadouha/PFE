  ...
  <div class="container-fluid px-3">
    ...
    <nav aria-label="breadcrumb" class="d-none d-lg-block me-auto">
      <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0">
        <li class="breadcrumb-item text-sm">
          <a class="text-secondary" href="<?php echo e(route('dashboard')); ?>">
    ...
    <div class="d-flex align-items-center justify-content-end ms-auto" id="navbar" style="gap:12px;flex-wrap:nowrap;min-width:0;">
      ...
      <ul class="navbar-nav d-flex align-items-center justify-content-end ms-2">
        ...
        <li class="nav-item dropdown px-2">
          <a href="#" class="nav-link text-body p-0 position-relative d-flex align-items-center justify-content-center" 
            ...
            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill"
                  style="font-size:9px; padding:4px 6px; background:linear-gradient(135deg, #ef4444, #b91c1c); border: 2px solid #fff; box-shadow: 0 4px 10px rgba(239, 68, 68, 0.3);" id="notif-badge"><?php echo e($notifCount); ?></span>
            <?php endif; ?>
          </a>
          ...
          <div class="dropdown-menu dropdown-menu-end notif-dropdown-menu mt-2 p-0"
            ...
            <div class="d-flex align-items-center justify-content-between px-3 py-3"
              ...
              <span class="badge" style="background:rgba(255,255,255,0.25);color:white;font-size:11px;">
                <?php echo e($notifCount); ?> non lue(s)
              </span>
              <?php endif; ?>
            </div>
            ...
            <div id="notif-list"
              ...
              ?>
              <div class="notif-card" id="notif-<?php echo e($notif->id); ?>"
                   data-notif-id="<?php echo e($notif->id); ?>"
                   data-notif-url="<?php echo e($notif->url ?? ''); ?>"
                ...
                <div style="display:flex;align-items:stretch;">
                  <div style="width:4px;background:<?php echo e($grad); ?>;flex-shrink:0;"></div>
                  <div class="notif-inner d-flex align-items-center px-3 py-3 w-100"
                    ...
                    <div style="width:42px;height:42px;border-radius:11px;flex-shrink:0;
                                background:<?php echo e($grad); ?>;
                                display:flex;align-items:center;justify-content:center;
                                box-shadow:0 3px 8px rgba(0,0,0,0.13);">
                      <i class="material-symbols-rounded text-white" style="font-size:22px;"><?php echo e($notif->icon); ?></i>
                    </div>
                    <div style="flex:1;min-width:0;">
                      ...
                      <p class="mb-1" style="font-size:12px;color:#64748b;line-height:1.3;white-space:normal;">
                        <?php echo e(Str::limit($notif->body, 60)); ?>

                      </p>
                      <?php endif; ?>
                      <div class="d-flex align-items-center" style="gap:4px;">
                        <i class="material-symbols-rounded" style="font-size:11px;color:#94a3b8;">schedule</i>
                        <span style="font-size:11px;color:#94a3b8;"><?php echo e($ago); ?></span>
                      </div>
                    </div>
                    <button type="button"
        ...
        <script>
        var _notifCsrf = "<?php echo e(csrf_token()); ?>";
        ...
        <li class="nav-item dropdown ps-2" style="position:relative; z-index:1050;">
          <a href="#" class="nav-link text-body p-0 d-flex align-items-center px-3 py-2" 
            ...
            ?>
            <div class="d-flex align-items-center">
              <div class="avatar avatar-sm shadow-sm me-2" style="background:<?php echo e($roleData['bg']); ?>;overflow:hidden; border-radius:12px !important; width:34px; height:34px;">
                <?php if(auth()->user()->avatar): ?>
                  <img src="<?php echo e(asset('storage/' . auth()->user()->avatar)); ?>" style="width:100%;height:100%;object-fit:cover;" alt="">
                <?php else: ?>
                  <span class="text-white text-xs font-weight-bold" style="font-size:11px;"><?php echo e($initials); ?></span>
                <?php endif; ?>
              </div>
              <div class="d-none d-lg-block text-start">
                ...
                <span class="text-xxs font-weight-bold uppercase" style="line-height:1; color:#94a3b8; font-size:9px; letter-spacing:0.02em;"><?php echo e($roleData['name']); ?></span>
              </div>
          ...
          <ul class="dropdown-menu dropdown-menu-end px-2 py-3 mt-2" style="min-width:280px; border-radius:20px; border:none; box-shadow: 0 10px 40px rgba(0,0,0,0.12); overflow: hidden; z-index: 1055;">
            <li class="mb-2 px-2">
              <div class="d-flex align-items-center p-2" style="background:#f8fafc; border-radius:14px;">
                <div class="avatar avatar-md shadow-sm" style="background:<?php echo e($roleData['bg']); ?>;overflow:hidden; border-radius:12px !important;">
                  <?php if(auth()->user()->avatar): ?>
                    <img src="<?php echo e(asset('storage/' . auth()->user()->avatar)); ?>" style="width:100%;height:100%;object-fit:cover;" alt="">
                <?php else: ?>
                  <span class="text-white font-weight-bold" style="font-size:14px;"><?php echo e($initials); ?></span>
                <?php endif; ?>
                </div>
                <div class="ms-3">
                  <h6 class="mb-0 text-sm font-weight-bold" style="letter-spacing:-0.01em;"><?php echo e(auth()->user()->name); ?></h6>
                  <p class="text-xs text-secondary mb-1" style="font-weight:500;"><?php echo e(auth()->user()->email); ?></p>
                  <span class="badge" style="background:<?php echo e($roleData['bg']); ?>; color:white; font-size:9px; font-weight:800; text-transform:uppercase; letter-spacing:0.04em; padding: 4px 10px; border-radius:8px;">
            ...
            <li>
              <a class="dropdown-item border-radius-lg d-flex align-items-center py-2 px-3" href="<?php echo e(route('profile.edit')); ?>" style="border-radius:12px !important; transition: all 0.2s ease;">
            ...
            <li>
              <a class="dropdown-item border-radius-lg d-flex align-items-center py-2 px-3" href="<?php echo e(route('super-admin.settings')); ?>" style="border-radius:12px !important; transition: all 0.2s ease;">
                <div style="width:32px; height:32px; border-radius:10px; background:#f1f5f9; display:flex; align-items:center; justify-content:center; margin-right:12px;">
