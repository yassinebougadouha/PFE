...
@endphp
<html lang="fr" data-bs-theme="{{ $resolvedTheme === 'dark' ? 'dark' : 'light' }}" id="html-root">
<head>
  <meta charset="UTF-8">
  ...
  {{-- ✅ Apply sidebar-collapsed on <html> IMMEDIATELY before any CSS/JS loads --}}
  <script>
...
<body class="g-sidenav-show bg-gray-100">
  ...
  {{-- Apply to body too, right before sidebar renders --}}
  <script>
    if (localStorage.getItem('sidebar_collapsed') === '1') {
  ...
  @include('partials.support-api')

  {{-- ✅ Re-apply after material-dashboard.min.js (it overrides margin) --}}
  <script>
    (function() {
      if (localStorage.getItem('sidebar_collapsed') === '1') {
