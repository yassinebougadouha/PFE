...
<div class="row mb-2">
  <div class="col-12">
    @php
      ...
      $validTabs = ['general','tickets','security','notifications','system','glpi','sms'];
      if(!in_array($activeTab,$validTabs)) $activeTab='general';
    @endphp
    <ul class="nav mb-3 flex-wrap" id="settingsTabs" role="tablist"
        style="background:var(--color-background-secondary);border-radius:14px;padding:5px;gap:3px;border:1px solid var(--color-border-tertiary);display:inline-flex;">
      <li class="nav-item">
  ...
  <div class="tab-pane fade {{ $activeTab === 'sms' ? 'show active' : '' }}" id="sms" role="tabpanel">
    ...
    <style>
      ...
      #settingsTabs .nav-link {
        ...
        padding:8px 16px; border-radius:10px; color:var(--color-text-secondary);
        background:transparent; border:none; transition:all .15s ease; white-space:nowrap;
      }
      #settingsTabs .nav-link .material-symbols-rounded { font-size:16px; }
      ...
      @media (max-width: 1100px) {
        .sms-split-layout { flex-direction: column; }
        .sms-split-right { width: 100%; position: static; }
      }
