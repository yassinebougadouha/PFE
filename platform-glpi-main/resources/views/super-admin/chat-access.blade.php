...
@section('title', 'Acces chat - Super Admin')
...
<div class="ca-wrap">
  <div class="ca-head">
    <div>
      ...
      <div class="ca-sub">Meme logique que le module React: gestion des droits de reponse Conversations et WhatsApp.</div>
    </div>
...
const OPERATORS_INDEX_URL = @json(route('super-admin.chat-access.operators.index'));
